...
int main(int argc, char * argv[]) {
  ...
  TH1F* totalelectrons = new TH1F("totalelectrons","",20,50,1050);
  TH1F* lostelectrons =  new TH1F("lostelectrons","",20,50,1050);
  TH1F* fractionup =  new TH1F("fractionup","",20,50,1050);
  TH1F* fractionplastic  =  new TH1F("fractionplastic","",20,50,1050);
  TH1F* fractionlow =  new TH1F("fractionlow","",20,50,1050);
  ...
  std::string search = "/d-200"; //stringa da <cercare 
    ...
    TLatex *text = new TLatex(50, 12000, c);
    ...
    TLatex *text2 = new TLatex(750,1250, b);
