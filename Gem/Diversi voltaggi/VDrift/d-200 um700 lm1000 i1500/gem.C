...
int main(int argc, char * argv[]) {
  ...
  const double induction =1500;
  const double upmetal=700;
  const double lowmetal=1000;
  ...
  totalelectrons->Fill(300,71);
  lostelectrons->Fill (300,35);
  totalelectrons->Fill(350,128);
  lostelectrons->Fill (350,53);
  totalelectrons->Fill(400,447);
  lostelectrons->Fill (400,190);
  totalelectrons->Fill(450,1222);
  lostelectrons->Fill (450,430);
  totalelectrons->Fill(500,2842);
  lostelectrons->Fill (500,1314);
  totalelectrons->Fill(550,8168);
  lostelectrons->Fill (550,3404);
  ...
  // TLatex *text = new TLatex(250, 8700, c);
  // sprintf(b,"#splitline{Drift field: %.0f kV/cm}{Transfer field: %.0f kV/cm}",(upmetal-drft)/100,(induction-lowmetal)/100);   //Fattore 100 ingloba spazio di drift e conversione V->kV
  // TLatex *text2 = new TLatex(275, 1600, b);
  ...
  char oldname[1024]; //
  char newname[1024];
  sprintf(newname,"/home/francesco/Garfield-Simulations/Gem/Diversi voltaggi/VDrift/d%.0f um%.0f lm%.0f i%.0f",drft,upmetal,lowmetal,induction);
