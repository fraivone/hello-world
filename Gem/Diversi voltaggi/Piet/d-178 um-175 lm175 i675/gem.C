	  ...
	  if(a.find("d-")!=std::string::npos)
	    {
	      ...
	      const std::string efile = a+"ELIST.lis";
	      const std::string nfile = a+"NLIST.lis";
	      const std::string mfile = a+"MPLIST.lis";
	      const std::string sfile = a+"PRNSOL.lis";
		...
		hChrgI->Draw();
	      ...
	      meshView->Plot();
	      c87->Save("Top 5 1-Gev muons.pdf");
	      c87->Close();
	      ...
	      meshView2->Plot();
	      c88->Save("Top 5 1-Gev muons.pdf");
	      c88->Close();
