...
int main(int argc, char * argv[]) {
  ...
  lostelectrons->SetXLabelSize(0.034);
  lostelectrons->SetYLabelSize(0.034);
  ...
  Float_t vals[][3] ={{41.38,29.31,27.59},{13,51,36},{7.26,56.47,36.28},{8.26,69.78,21.97},{4.95,83.45,11.56},{5.2,79.83,14.97}};
