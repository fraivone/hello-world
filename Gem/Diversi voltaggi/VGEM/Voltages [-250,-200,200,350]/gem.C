...
int main(int argc, char * argv[]) {
  ...
  TH1F* hChrgI = new TH1F("hChrgI", "Position of the ions on plastic", 
                          nBinsChrg, -0.5e4 * kapton, 0.5e4 * kapton);
  TH1F* totalelectrons = new TH1F("totalelectrons","Electron Transfered/Lost",10,400,600);
  TH1F* lostelectrons =  new TH1F("lostelectrons","",10,200,400);
  ...
  totalelectrons->Fill(550,sumElectronsTotal);
  lostelectrons->Fill (550,sumElectronsPlastic+sumElectronsUpperMetal+sumElectronsLowerMetal+sumElectronsOther);
  ...
  totalelectrons->SetBarWidth(0.4);
  totalelectrons->SetBarOffset(0.);
  totalelectrons->SetXTitle("Voltage on the GEM");
