...
int main(int argc, char * argv[]) {
  ...
  const double induction =780;
  const double upmetal=-100;
  const double lowmetal=280;
  ...
  char oldname[1024]; //
  char newname[1024];
  sprintf(newname,"/home/francesco/Garfield-Simulations/Gem/Diversi voltaggi/VGEM/d%.0f um%.0f lm%.0f i%.0f",drft,upmetal,lowmetal,induction);
