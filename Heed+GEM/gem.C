...
int main(int argc, char * argv[]) {
  ...
  meshView->SetPlane(0,-1, 0,pitch/2,sqrt(3)/2 * pitch,0.004);
  ...
  meshView2->SetPlane(0,.0,+1,pitch/2,0.,0.002);
  meshView2->SetFillMesh(true);
  meshView2->SetColor(1, 5);
  meshView2->SetViewDrift(driftView);
  meshView2->SetArea(pitch/2-0.01, -0.01, 0.,pitch/2+0.01, +0.01, 0.03);
  meshView2->Plot();
